...
from .views import exportar_reporte_completo, exportar_reporte_fecha, home, administrar_productos, reportes, tienda, ficha, registro
...
urlpatterns = [
    ...
    path('exportar/exportar_reporte_completo/', exportar_reporte_completo, name="exportar_reporte_completo"),
    path('exportar/exportar_reporte_fecha/', exportar_reporte_fecha, name="exportar_reporte_fecha"),
]